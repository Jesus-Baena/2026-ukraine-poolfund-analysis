...
ggplot(grants, aes(x = Budget, fill = Context, color = Context)) +
  ...
  geom_label(data = medians,
             aes(x = med, y = Inf,
                 label = paste0("Median\n$", scales::comma(round(med / 1e3), suffix = "K")),
                 color = Context),
...
ggplot() +
  ...
  scale_color_manual(
    values = c("TRUE" = "#e63946", "FALSE" = "#94d2bd"),
    guide  = "none"
  ) +
  scale_shape_manual(values = c("INGO" = 16, "NNGO" = 1), name = NULL) +
  labs(
    title    = "Median Grant Size: INGO vs NNGO per CBPF Fund (2014–2025)",
    subtitle = "Sorted by INGO/NNGO ratio (right labels)  |  <b style='color:#e63946'>Ukraine highlighted</b>  |  filled = INGO, open = NNGO",
  ...
  theme(
    ...
    axis.text.y        = element_text(
      ...
      color = ifelse(levels(fund_wide$PooledFundName) == "Ukraine", "#e63946", "grey30")
    )
  )
```
